...
const ServiceCard = ({ service, index }) => {
  ...
  return (
    <motion.div
      ...
      className="bg-dark-200 p-6 rounded-xl shadow-dark-md hover:shadow-dark-lg border border-dark-300 transition-all"
    >
...
const Services = () => {
  ...
  return (
    <section id="services" ref={sectionRef} className="py-20 bg-dark-100">
