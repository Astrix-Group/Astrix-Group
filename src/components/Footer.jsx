...
const Footer = () => {
  ...
  return (
    <footer className="bg-dark-100 text-white py-12 border-t border-dark-300">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            >
              <h3 className="text-2xl font-bold mb-4 text-primary">Astrix Group</h3>
              ...
              <div className="flex space-x-4">
                <a href="https://discord.gg/RsM2TXmr3t" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-primary transition-colors">
          ...
          >
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#technologies" className="text-gray-300 hover:text-primary transition-colors">Technologies</a></li>
              <li><a href="#team" className="text-gray-300 hover:text-primary transition-colors">Team</a></li>
        ...
        <motion.div
          ...
          className="border-t border-dark-300 mt-12 pt-8 text-center"
        >
          <div className="text-center">
            ...
            <div className="flex justify-center space-x-6 text-sm mt-4">
              <Link to="/terms" className="text-gray-400 hover:text-primary transition-colors font-medium">Terms of Service</Link>
              <span className="text-gray-600">|</span>
              <a href="https://discord.gg/RsM2TXmr3t" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-primary transition-colors font-medium">Discord</a>
            </div>
          </div>
        </motion.div>
      </div>
